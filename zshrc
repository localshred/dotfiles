...
plugins=(git textmate gitflow-completion brew ruby)

source $ZSH/oh-my-zsh.sh

# Customize to your needs...
export PATH=/usr/bin:/bin:/usr/sbin:/sbin:/usr/local/bin:/usr/X11/bin:/Users/bj/.rvm/bin:/usr/local/lib/node_modules
